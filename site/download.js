...
function renderCards(overview) {
    ...
    const ghUrl = overview.github_release_url || 'https://github.com/nightcordoff/nightcordclient-releases/releases/latest';
    ...
    document.getElementById('download-grid').innerHTML = `
        <article class="download-card glass" data-channel="stable">
            ...
            <a class="button button-primary" href="${ghUrl}" target="_blank" rel="noopener noreferrer" data-action="stable">
        ...
        <article class="download-card glass" data-channel="linux">
            ...
            <div class="download-card-spacer"></div>
            <a class="button button-primary" href="${ghUrl}" target="_blank" rel="noopener noreferrer" data-action="linux">
